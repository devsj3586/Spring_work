...
public class HomeController {
	@Autowired
	WebApplicationContext servletAC; // Servlet AC - 얻는방법
	...
	public String home(Locale locale, HttpServletRequest request, Model model) {
		...
		WebApplicationContext rootAC = WebApplicationContextUtils.getWebApplicationContext(sc); // Root AC  Root 가져오는 방법

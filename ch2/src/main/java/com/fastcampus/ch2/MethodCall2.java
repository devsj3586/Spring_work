...
public class MethodCall2 {
	public static void main(String[] args) throws Exception{
		...
		// 4. main메서드를 호출 invoke 사용 
		// String viewName = obj.main(2021, 10, 1, model);  // 아래줄과 동일 
		String viewName = (String)main.invoke(obj, new Object[] { 2021, 10, 1, model }); 	// Reflection API를 이용한 호출 2021, 10, 1, model 매개변수 

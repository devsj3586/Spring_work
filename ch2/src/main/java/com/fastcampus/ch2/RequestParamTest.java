...
//	public String main2(@RequestParam(name="year", required=false) String year) {   // 아래와 동일  required 필수 여부 
...
//		public String main3(@RequestParam(name="year", required=true) String year) {   // 아래와 동일  필요할땐 명시적으로 required 적기 
...
//		http://localhost/ch2/requestParam7?year   ---->> 400 Bad Request, nested exception is java.lang.NumberFormatException: For input string: "" 
	...
	public String main8(@RequestParam(required=false) int year) {    // 필수 입력 X  타입 int - 변환까지 해야됨. 필수입력이 아닐댄 기본값 있어야함.
